						...
						<div class="all">
							...
							<div class="box">
								...
								<div class="3">
									...
									<p class="des">- 음주, 심신미약 등 운전이 불가 판단 시, 고객님의 운전능력이 도로교통 상황에 비하여 현저하게 미숙하다 판단 시 과속/위험운전/법규위반 등의 경우에는</p>
									<p class="des" style="margin-left:7px;">시승을 제한 받을 수 있으며 향후 시승서비스 이용에도 불이익을 받을 수 있습니다.</p>
								</div>
							</div>
							<div class="ck_box">
								<input type="checkbox">
